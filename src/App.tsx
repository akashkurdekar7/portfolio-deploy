...
const App = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-white text-black">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[200] focus:rounded-md focus:bg-black focus:px-4 focus:py-2 focus:font-bricolage focus:text-sm focus:text-white"
      >
        Skip to content
      </a>
